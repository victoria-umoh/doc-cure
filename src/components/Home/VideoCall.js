...
import VideoCal from '../../assets/img/video-call.jpg'
												...
												<div class="user-details">
													<div class="float-left user-img">
														<a class="avatar avatar-sm mr-2" href="patient-profile.html" title="Charlene Reed">
															<img src={Patient} alt="User Image" class="rounded-circle" />
										...
										<div class="call-contents">
											<div class="call-content-wrap">
												<div class="user-video">
													<img src={VideoCal} alt="User Image" />
												</div>
												<div class="my-video">
													<ul>
														<li>
															<img src={Patient} class="img-fluid" alt="User Image" />
														</li>
													</ul>
												</div>
											</div>
