...
export class components extends Component {
  render() {
	return (
	  <>
		 {/* Breadcrumb  */}
			<div classNameName="breadcrumb-bar">
				<div classNameName="container-fluid">
					<div classNameName="row align-items-center">
						<div classNameName="col-md-12 col-12">
							<nav aria-label="breadcrumb" classNameName="page-breadcrumb">
								<ol classNameName="breadcrumb">
									<li classNameName="breadcrumb-item"><a href="index-2.html">Home</a></li>
						...
						<section className="comp-section comp-buttons">
							...
							<div className="card">
								<div className="card-header">
									...
									<p className="card-text">use <code>.btn-rounded</code> in className <code>.btn</code> className to get Rounded button</p>
								</div>
								<div className="card-body">
									...
									<hr />
									<p>use <code>.btn-rounded</code> in className <code>.btn-outline-*</code> className to get Rounded Outline button</p>
							...
							<div className="card">
								<div className="card-header">
									...
									<p className="card-text">Use <code>.btn-outline-*</code> className for outline buttons.</p>
								</div>
								<div className="card-body">
