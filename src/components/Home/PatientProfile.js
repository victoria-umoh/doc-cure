								...
								<ul className="list-group list-group-flush">
									<li className="list-group-item">
										<div className="media align-items-center">
											<div className="mr-3">
												<img alt="Image placeholder" src={DoctorThumb02} className="avatar rounded-circle" />
											</div>
									...
									<div className="tab-content">
														...
														<table className="table table-hover table-center mb-0">
															...
															<tbody>
																...
																<tr>
																	...
																	<td className="text-right">
																		<div className="table-action">
																			<a href="edit-prescription.html" className="btn btn-sm bg-success-light">
																				<i className="far fa-edit"></i> Edit
																			</a>
										...
										<div className="tab-pane fade" id="pres">
											<div className="text-right">
												<a href="add-prescription.html" className="add-new-btn">Add Prescription</a>
											</div>
											<div className="card card-table mb-0">
												<div className="card-body">
													<div className="table-responsive">
										...
										<div className="tab-pane fade" id="medical">
											<div className="text-right">		
												<a href="#" className="add-new-btn" data-toggle="modal" data-target="#add_medical_records">Add Medical Records</a>
											</div>
											<div className="card card-table mb-0">
												<div className="card-body">
													<div className="table-responsive">
																...
																<tr>
																	...
																	<td className="text-right">
																		<div className="table-action">
																			...
																			<a href="edit-prescription.html" className="btn btn-sm bg-success-light" data-toggle="modal" data-target="#add_medical_records">
																				<i className="fas fa-edit"></i> Edit
																			</a>
																			<a href="javascript:void(0);" className="btn btn-sm bg-danger-light">
																				<i className="far fa-trash-alt"></i> Delete
										...
										<div className="tab-pane" id="billing">
											<div className="text-right">
												<a className="add-new-btn" href="add-billing.html">Add Billing</a>
											</div>
											<div className="card card-table mb-0">
												<div className="card-body">
													<div className="table-responsive">
																...
																<tr>
																	...
																	<td className="text-right">
																		<div className="table-action">
																			...
																			<a href="edit-billing.html" className="btn btn-sm bg-success-light">
																				<i className="fas fa-edit"></i> Edit
																			</a>
																			<a href="javascript:void(0);" className="btn btn-sm bg-danger-light">
																				<i className="far fa-trash-alt"></i> Delete
