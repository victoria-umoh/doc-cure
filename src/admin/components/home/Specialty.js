...
import Specialty2 from '../../assets/img/specialities/specialities-02.png'
											...
											<tbody>
													...
													<td>
														<h2 className="table-avatar">
															<a href="profile.html" className="avatar avatar-sm mr-2">
																<img className="avatar-img" src={Specialty1} alt="Speciality" />
															</a>
												...
												<tr>
													...
													<td>
														<h2 className="table-avatar">
															<a href="profile.html" className="avatar avatar-sm mr-2">
																<img className="avatar-img" src={Specialty2} alt="Speciality" />
															</a>
												...
												<tr>
													...
													<td>
														<h2 className="table-avatar">
															<a href="profile.html" className="avatar avatar-sm mr-2">
																<img className="avatar-img" src={Specialty3} alt="Speciality" />
															</a>
												...
												<tr>
													...
													<td>
														<h2 className="table-avatar">
															<a href="profile.html" className="avatar avatar-sm mr-2">
																<img className="avatar-img" src={Specialty4} alt="Speciality" />
															</a>
												...
												<tr>
													...
													<td>
														<h2 className="table-avatar">
															<a href="profile.html" className="avatar avatar-sm mr-2">
																<img className="avatar-img" src={Specialty5} alt="Speciality" />
															</a>
							...
							<form>
								<div className="row form-row">
									<div className="col-12 col-sm-6">
										<div className="form-group">
											<label>Specialities</label>
											<input type="text" className="form-control" value="Cardiology" />
										</div>
									</div>
									<div className="col-12 col-sm-6">
										<div className="form-group">
